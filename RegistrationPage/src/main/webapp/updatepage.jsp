...
<body>
     ...
     <div class="main-container">
         ...
         <div class="form-container fade-in">
             ...
             <form id="registrationFormupdate" action="update" method="post">
            <div class="form-grid">
                    <div class="form-group">
                        <label for="name">Full Name</label>
                        <div class="input-wrapper">
                            <i class="fas fa-user"></i>
                            <input type="text" id="name" name="name" value="${user.name}" placeholder="John Doe" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="email" id="email" name="email" value="${user.email}" placeholder="john@example.com" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="tel" id="mobile" name="mobile" value="${user.mobile}" placeholder="+91 84478 52890" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group full-width">
                        ...
                        <div class="radio-group">
                            ...
                            <div class="radio-option">
                                <input type="radio" id="prefer-not-to-say" name="gender" value="prefer not to say" ${user.gender == 'prefer not to say' ? 'checked' : ''}>
